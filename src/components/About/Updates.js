...
export default function Updates() {
    ...
    const updates = [{title:"3800 Players",
        date:"Aug 20, 2021",
        description:"Over the previous weekend I shared this website on /r Chess. Thanks to the support from that community and several other online communities, I now have over 3800 players who have submitted their ratings to the database. This goes a long way to helping us have pleanty of data to show the relationship between different ratings from FIDE, USCF, Chess.com and Lichess"
